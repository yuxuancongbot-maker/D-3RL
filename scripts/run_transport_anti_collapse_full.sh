...
# ============================================================
# Ada-BRIDGER Transport full pipeline (anti-collapse)
# Stages:
...
# ---------- Paths (aligned with train_ada_bridger_workspace_transport_anti_collapse.yaml) ----------
VAE_CKPT="weights/lowdim/predictor/vae/vae_transport_lowdim/checkpoints/latest.ckpt"
DIFF_CKPT="weights/lowdim/diffusion/robomimic/cnn/transport/latest.ckpt"

ORACLE_DIR="data/oracle_labels/transport_abs_v1"
SCHED_DIR="data/outputs/ada_scheduler_transport"
RUN_DIR="data/outputs/ada_bridger_rl_transport_v1"
EVAL_DIR="data/outputs/eval_ada_bridger_transport_v1"

# ---------- Common ----------
DEVICE="cuda:0"
CONFIG_NAME="train_ada_bridger_workspace_transport_anti_collapse"
...
echo "[DONE] Transport anti-collapse full pipeline finished."
